...
namespace RadioEtzionProject.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
...

        {
            ...
            string sql = "SELECT UserEmail,UserFirstName,UserLastName,UserPassword,UserPhone,UserPicture,Ranks_RanksID FROM db_a49040_master.Users where UserEmail=@userEmail";
        ...
        public int UpdateUser([FromBody] User user)
        {
            ...
            string sql = "UPDATE db_a49040_master.Users SET UserFirstName =@UserFirstName , UserLastName = @UserLastName, UserPassword = @UserPassword, UserPhone = @UserPhone, UserPicture = @UserPicture WHERE UserEmail =@UserEmail";
...

        {
            ...
            User userFromDb = null;
            string sqlSelect = "SELECT UserEmail,UserFirstName,UserLastName,UserPassword,UserPhone,UserPicture,Ranks_RanksID FROM db_a49040_master.Users where UserEmail=@userEmail";
            ...
            string sql = "INSERT INTO db_a49040_master.Users (UserEmail, UserFirstName, UserLastName, UserPassword, UserPhone, UserPicture,Ranks_RanksID) VALUES(@UserEmail, @UserFirstName, @UserLastName, @UserPassword, @UserPhone, @UserPicture, @UserRank)";
